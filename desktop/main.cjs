...
function startBackend() {
  return new Promise((resolve, reject) => {
    ...
    for (const key of ['DB_PATH', 'SKILLS_ROOT', 'HERMES_SKILLS_ROOTS', 'CHAT_UPLOAD_ROOT', 'SERVER_PORT', 'FRONTEND_ORIGIN', 'JWT_SECRET']) {
      delete backendEnv[key]
    }
    backendEnv.SLIMEBOT_HOME = path.join(app.getPath('userData'), 'data')
